...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1725834580);
user_pref("app.update.lastUpdateTime.background-update-timer", 1725834580);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1725834580);
user_pref("app.update.lastUpdateTime.region-update-timer", 1725488967);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1725834580);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1723602348);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1725834580);
...
user_pref("browser.startup.lastColdStartupCheck", 1725834550);
...
user_pref("media.gmp-manager.lastCheck", 1725834575);
user_pref("media.gmp-manager.lastEmptyCheck", 1725834575);
...
user_pref("toolkit.startup.last_success", 1725834549);
