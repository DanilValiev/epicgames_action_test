...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1727303461);
user_pref("app.update.lastUpdateTime.background-update-timer", 1727303461);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1727303461);
user_pref("app.update.lastUpdateTime.region-update-timer", 1727303461);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1727303461);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1723602348);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1727303461);
