...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1725661846);
user_pref("app.update.lastUpdateTime.background-update-timer", 1725661846);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1725748241);
user_pref("app.update.lastUpdateTime.region-update-timer", 1725488967);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1725661846);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1723602348);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1725661846);
...
user_pref("browser.startup.lastColdStartupCheck", 1725748211);
...
user_pref("media.gmp-manager.lastCheck", 1725661841);
user_pref("media.gmp-manager.lastEmptyCheck", 1725661841);
...
user_pref("toolkit.startup.last_success", 1725748210);
