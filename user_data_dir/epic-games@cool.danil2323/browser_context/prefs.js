...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1728599481);
user_pref("app.update.lastUpdateTime.background-update-timer", 1728599481);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1728685834);
user_pref("app.update.lastUpdateTime.region-update-timer", 1728599481);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1728599481);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1723602348);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1728599481);
...
user_pref("browser.startup.lastColdStartupCheck", 1728772224);
...
user_pref("media.gmp-manager.lastCheck", 1728599477);
user_pref("media.gmp-manager.lastEmptyCheck", 1728599477);
...
user_pref("toolkit.startup.last_success", 1728685803);
