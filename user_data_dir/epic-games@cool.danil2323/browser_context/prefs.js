...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1727908321);
user_pref("app.update.lastUpdateTime.background-update-timer", 1727908321);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1727994700);
user_pref("app.update.lastUpdateTime.region-update-timer", 1727908321);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1727908321);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1723602348);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1727908321);
...
user_pref("browser.startup.lastColdStartupCheck", 1727994670);
...
user_pref("media.gmp-manager.lastCheck", 1727908316);
user_pref("media.gmp-manager.lastEmptyCheck", 1727908316);
...
user_pref("toolkit.startup.last_success", 1727994669);
