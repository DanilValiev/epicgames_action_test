...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1724970626);
user_pref("app.update.lastUpdateTime.background-update-timer", 1724970626);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1725057011);
user_pref("app.update.lastUpdateTime.region-update-timer", 1724884132);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1724970626);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1723602348);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1724970626);
...
user_pref("browser.startup.lastColdStartupCheck", 1725056981);
...
user_pref("media.gmp-manager.lastCheck", 1724970622);
user_pref("media.gmp-manager.lastEmptyCheck", 1724970622);
...
user_pref("toolkit.startup.last_success", 1725056980);
